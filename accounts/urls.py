...
url(r'^editemployee/(?P<pk>\d+)', views.editemployee, name="editemployee"),
url(r'^deleteemployee/(?P<pk>\d+)', views.deleteemployee, name="deleteemployee"),
url(r'^viewemployees', views.viewemployees, name="viewemployees"),
