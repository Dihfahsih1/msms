...
class DataStudent(models.Model):
    ...
    gender = models.CharField(max_length=130, choices=sex, blank=False)
    Class = models.ForeignKey(Classinformation, on_delete=models.PROTECT, blank=True, null=True)
    stream = models.ForeignKey(Sectioninformation, on_delete=models.CASCADE, related_name='students')
...
class FeeCollection(models.Model):
    ...
    Class = models.CharField(max_length=130, default="netr")
    Section = models.CharField(max_length=130, default="netr")
    Student_Name = models.CharField(max_length=130, default="netr")
