...
def guardianofstudentdetails(request, pk):
    ...
    for student in students_info:
        all_info = Guardian.objects.filter(name=student.Guardian)
...
def viewdesignations(request):
   ...
   return render(request, 'accounts/Employees/viewdesignations.html', context)
#####################################################
#CONFIRMING DELETION, DISPLAY MESSAGE AND SUCCESS URL #
#####################################################
...
class Addfeescollection(FormView):
    ...
    template_name = 'accounts/Accounting/Addfeescollection.html'
